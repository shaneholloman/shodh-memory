...
const LEGAL_SUFFIXES: &[&str] = &[
    "inc", "inc.", "incorporated", "corp", "corp.", "corporation", "co", "co.", "company", "ltd",
    "ltd.", "limited", "llc", "l.l.c.", "plc", "p.l.c.", "gmbh", "ag", "sa", "s.a.", "nv", "n.v.",
    "bv", "b.v.", "ab", "oyj", "pty", "spa", "s.p.a.", "sas", "kgaa", "as", "a/s",
];
